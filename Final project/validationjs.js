let subButton = document.getElementById("buttons");

subButton.addEventListener("click", validateName);
subButton.addEventListener("click", ccChoiceValidaton);
...
// Check is the ownner's name is entered on the card
function validateName() {
 ...
 function ccChoiceValidaton() {
    let card = document.forms.reservationForm.elements.credit[0];
...
function luhn(idNum) {
 ...
 window.onload = function() {
    document.forms[0].onsubmit = function() {
       if (this.checkValidity()) alert("Welcome to Gym Mania! Submission has been recieved");
       return false;
    };
 };